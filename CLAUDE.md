...
Run with `xcodebuild test`. **155 tests** across 16 test files, all passing in ~2s, zero `swiftlint --strict` violations. Release builds clean with `SWIFT_TREAT_WARNINGS_AS_ERRORS: YES`.
